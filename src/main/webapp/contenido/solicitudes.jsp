    ...
    <section class="gestion">
        ...
        <div class="gestion__panel">
            ...
            <article class="solicitud-card">
                <img class="solicitud-card__img" src="../imagenes/finca.jpeg" alt="Foto de la finca" />

                <div class="solicitud-card__info">
                    <p><strong>Finca:</strong></p>
                    <p><strong>Ubicación:</strong></p>
                    <p><strong>Fecha de envío:</strong></p>
                    <p><strong>Fecha de límite de respuesta:</strong></p>
                </div>

                <div class="solicitud-card__detalles">
                    <a href="detalles-oferta.html" class="btn-dark btn-dark--detalles">Detalles</a>
                </div>
        ...
        <a  href="./histo-solicitudes.jsp" class="btn-dark btn-dark--historial">Historial</a>
