...
<main class="container perfil perfil-propietario">
  ...
  <div class="perfil-top">
    ...
    <a href="./busqueda.jsp" class="perfil-top__arrow" aria-label="Volver">→</a>
  </div>
  ...
  <section class="perfil-bottom">
    ...
    <div class="perfil-actions">
      <a href="./busqueda.jsp" class="btn-dark perfil-actions__btn">Cancelar</a>
      <a href="./info-guardada2.jsp" class="btn-dark perfil-actions__btn" type="submit">
        Guardar cambios
      </a>
    </div>
