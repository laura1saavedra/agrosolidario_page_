    ...
    <section class="aceptados">
        ...
        <article class="aceptados-card">
            <div class="aceptados-card__left">
                ...
                <a href="./selec-persona.html" class="btn-dark aceptados-card__btn">Seleccionar</a>
            </div>
        ...
        <div class="aceptados-nav">
            <a href="./lista-oferta.jsp" class="btn-dark aceptados-nav__btn">Volver</a>
            <a href="" class="btn-dark aceptados-nav__btn">Siguiente</a>
        </div>
    </section>
